...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from '../ui/dialog_old';
        ...
        <ScrollArea className='mt-8 max-h-[420px] pr-6'>
          {server?.members?.map((member) => (
            <div key={member.id} className='flex items-center gap-x-2 mb-6'>
              ...
              {loadingId === member.id && <Loader2 className='animate-spin text-zinc-500 h-4 w-4 ml-auto' />}
            </div>
          ))}
        </ScrollArea>
      </DialogContent>
